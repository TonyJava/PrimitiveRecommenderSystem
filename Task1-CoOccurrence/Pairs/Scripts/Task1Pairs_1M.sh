...
hadoop jar $STREAMING_JAR \
          ...
          -file /home/dbarbara/MOVIELENS/ml-1m/movies.dat
...
head -n 20 $BASE_FOLDER/output/outputPhase3/part-00000 > $BASE_FOLDER/output/Task1_ml-1M_Pairs_output.txt

#rm -r $OUTPUT3

hadoop fs -rm -r $HADOOP_USER_OUTPUT

echo "Output file "$BASE_FOLDER/output/Task1_ml-1M_Pairs_output.txt" created..."
