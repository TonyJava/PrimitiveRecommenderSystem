...
hadoop jar $STREAMING_JAR \
		  -input $INPUT1 \
          -output $OUTPUT1 \
          -mapper $BASE_FOLDER/src/Task1_100K_Map1.py \
...
hadoop fs -get $OUTPUT2/* $BASE_FOLDER/output/outputPhase2/
...
hadoop jar $STREAMING_JAR \
          ...
          -output $OUTPUT3 \
          -mapper $BASE_FOLDER/src/Task1_100K_Final_Map3.py \
          -reducer org.apache.hadoop.mapred.lib.IdentityReducer \
          -file /home/dbarbara/MOVIELENS/ml-100K/u.item
...
hadoop fs -get $OUTPUT3/* $BASE_FOLDER/output/outputPhase3/

head -n 20 $BASE_FOLDER/output/outputPhase3/part-00000 > $BASE_FOLDER/output/Task1_ml-100K_Pairs_output.txt

#rm -r $OUTPUT3

hadoop fs -rm -r $HADOOP_USER_OUTPUT

echo "Output file "$BASE_FOLDER/output/Task1_ml-100K_Pairs_output.txt" created..."
